...
<head>
     ...
     <title>Formulaire modification de film</title>
</head>
<body>
<header>
     <div>
...
<form  action="update.php?id=<?php echo $_GET['id'];?>"  target="_blank" method="POST" enctype="multipart/form-data">

<div class="container">

     <h1>Modifier <?php $nom = $_GET['nom']; echo $nom?>  </h1>
               ...
               <div class="container2">
                    ...
                    <div class="col1">
                              ...
                              <input type="date" name = "date_de_sortie"  placeholder="Date de Sortie">
                         </div>
